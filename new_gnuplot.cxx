...
void gnuplot_set_xrange(gnuplot_ctrl * h, double min, double max);

void gnuplot_set_yrange(gnuplot_ctrl * h, double min, double max);
...
void gnuplot_set_xrange(gnuplot_ctrl * h, double min, double max)
{
    gnuplot_cmd(h, "set xrange [%.2f:%.2f]", min, max) ;
}

void gnuplot_set_yrange(gnuplot_ctrl * h, double min, double max)
{
    gnuplot_cmd(h, "set yrange [%.2f:%.2f]", min, max) ;
}
